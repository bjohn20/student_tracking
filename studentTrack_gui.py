...
def load_gui(self):
    ...
    self.lbl_currcourse = tk.Label(self.master,text='Current Course:')
    self.lbl_currcourse.grid(row=8,column=0,padx=(27,0),pady=(10,0),sticky=N+W)
    ...
    self.txt_currcourse = tk.Entry(self.master,text='')
    self.txt_currcourse.grid(row=9,column=0,rowspan=1,columnspan=2,padx=(30,40),pady=(0,0),sticky=N+E+W)
    ...
    self.btn_add = tk.Button(self.master,width=10,height=2,text='Add',command=lambda: studentTrack_func.addToList(self))
    self.btn_add.grid(row=9,column=2,padx=(10,0),pady=(5,10),sticky=W)
    self.btn_delete = tk.Button(self.master,width=10,height=2,text='Delete',command=lambda: studentTrack_func.onDelete(self))
    self.btn_delete.grid(row=9,column=3,padx=(10,0),pady=(5,10),sticky=W)
    self.btn_close = tk.Button(self.master,width=10,height=2,text='Close',command=lambda: studentTrack_func.ask_quit(self))
    self.btn_close.grid(row=9,column=4,columnspan=1,padx=(10,0),pady=(5,10),sticky=E)
